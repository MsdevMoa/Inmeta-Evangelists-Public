...
```
az aks update -n <clustername> -g <ressourcegroup> --attach-acr birkmosewth

az aks create --resource-group <ressourcegroup> --name <clustername> --node-count 3  --enable-addons http_application_routing --zones 1 2 3 --enable-managed-identity
